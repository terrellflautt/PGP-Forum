            ...
            <>
              ...
              {mode === 'login' ? (
                ...
                <form onSubmit={handleEmailRegister} className="space-y-4">
                  <div>
                    <label htmlFor="register-name" className="block text-sm font-semibold text-secondary-900 mb-2">
                      Full Name
                    </label>
                    <input
                      id="register-name"
                  ...
                  <div>
                    <label htmlFor="register-email" className="block text-sm font-semibold text-secondary-900 mb-2">
                      Email Address
                    </label>
                    <input
                      id="register-email"
                      ...
                      required
                      className="w-full px-4 py-3 text-base border border-secondary-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                      placeholder="your@protonmail.com"
                      style={{ fontSize: '16px' }}
                    />
                    <p className="mt-1 text-xs text-secondary-500">
                      We support ProtonMail, GMX, and all other email providers
                    </p>
                  </div>

                  <div>
                    <label htmlFor="register-password" className="block text-sm font-semibold text-secondary-900 mb-2">
                      Password
                    </label>
                    <div className="relative">
                      <input
                  ...
                  <div>
                    <label htmlFor="register-confirm-password" className="block text-sm font-semibold text-secondary-900 mb-2">
                      Confirm Password
                    </label>
                    <input
